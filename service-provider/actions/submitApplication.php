...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    //  ✅ Input validation
    if (empty($your_price) || empty($request_id) || empty($duration)) {
        echo json_encode(['success' => false, 'error' => 'All fields are required.']);
        exit;
    }

    try {
        $sql = "INSERT INTO maintenance_request_proposals (maintenance_request_id, provider_id, bid_amount, estimated_time)
                VALUES (:maintenance_request_id, :provider_id, :bid_amount, :estimated_time)";
