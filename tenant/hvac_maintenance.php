                                        ...
                                        <div class="modal-body">
                                           <div class="row bg-danger" style="border-radius:5px; background-color:#cc0001 !important;">
                                              <div class="col-md-12 p-2 text-center">
                                                <b class="text-light">
                                                  <i class="fa fa-warning"></i> The HVAC Technician Service Provider reserves a right to access your house unit to assess the request made for proper and accurate procurement so that we may start the eradication process.
                                                </b>
                                              </div>
                                            </div> <hr>
                                            <div class="card shadow">
                                                <div class="card-header" style="background-color: #00172A; color: #fff;">
                                                    <b>Make a HVAC Issue Request</b>
                                                </div>
                                                <div class="card-body">
                                                    <div class="row">
                                                        <div class="col-md-12">
                                                            <div class="form-group">
                                                                <input type="hidden" class="form-control" name="hvac_issue" value="HVAC Issue">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="card shadow" style="border:1px solid rgb(0,25,45,0.3); display:none;" id="secondSection" >
                                                        ...
                                                        <div class="card-body">
                                                            <div class="form-group">
                                                                <label>HVAC Issue</label>
                                                                <select class="form-control" name="hvac_issue" id="hvac_issue">
                                                                  <option value="" hidden selected>-- Select Option --</option>
                                                                  <option>Air Conditioning Repair</option>
                                                                  <option>Air Conditioning Servicing</option>
                                                                  <option>Ventillation</option>
                                                                </select>
                                                                <b class="text-danger mt-2" id="hvacIssueError"></b>
                                                            </div>
                                                            <div class="form-group">
                                                                <label>Detailed Description</label> <sup class="text-danger"><b>*</b></sup>
                                                                <textarea name="hvac_desc" id="hvac_desc" class="form-control" required
                                                                          placeholder="Write a brief Description of your Request Here"></textarea>
                                                                <b class="text-danger mt-2" id="hvactDescError"></b>
                                                            </div>
                                                            <div class="row">
                                                                <div class="col-md-6">
                                                                    <div class="form-group">
                                                                        <label>Urgence Level</label>
                                                                        <select name="hvac_urgence" id="hvac_urgence" class="form-control">
                                                                        ...
                                                                        <b class="text-danger mt-2" id="hvacUrgenceError"></b>
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-6">
                                                                    <div class="form-group">
                                                    ...
                                                    <div class="card shadow" style="border:1px solid rgb(0,25,45, 0.3); display:none;" id="thirdSection">
                                                        ...
                                                        <div class="card-body">
                                                            <div class="row p-2">
                                                                <div class="col-md-6 text-center">
                                                                    <div class="form-group">
                                                                        <div class="custom-control custom-switch">
                                                                            <input type="radio" class="custom-control-input" id="customSwitchAttachPhotos" name="hvac_photos" value="Yes" onclick="displayToInsertHvacPhotos();" required>
                                                                ...
                                                                <div class="col-md-6 text-center">
                                                                    <div class="custom-control custom-switch">
                                                                        <input type="radio" class="custom-control-input" id="customSwitchNo" name="hvac_photos" value="No" onclick="displayToHideHvacPhotos();" required>
                                                                        <label class="custom-control-label" for="customSwitchNo">No</label>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="card shadow" id="hvacPhotosDiv" style="display: none; border:1px solid rgb(0, 25, 45, 0.3);">
                                                    ...
                                                    <div class="card shadow" style="border:1px solid rgb(0, 25, 45, 0.3); border-radius:3px; display:none;" id="fourthSection">
                                                        ...
                                                        <div class="card-body p-1">
                                                            <div class="form-group p-3">
                                                                <div class="custom-control custom-switch">
                                                                    <input type="radio" class="custom-control-input" id="customSwitchAuthorize" name="authorize_hvac_provider" value="Confirm Authorization">
                                                                    <label class="custom-control-label" for="customSwitchAuthorize"> I authorize the HVAC Technician Service provider to inspect and perform the requested services. Depending on the extent of the required service, I understand that additional charges may apply based on the final assessment.</label>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="card-footer text-right">
