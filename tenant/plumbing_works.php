            ...
            <div class="content-wrapper">
                ...
                <section class="content">
                    <div class="container-fluid">
                        ...
                        <div class="modal fade shadow" id="submitRequest" style="overflow-y: scroll; height: 700;">
                                ...
                                <div class="modal-content" style="background-color:#F2F3FA;">
                                    ...
                                    <form action="" method="post" enctype="multpart/form-data" autocomplete="off">
                                        <div class="modal-body">
                                           <div class="row bg-danger shadow" style="border-radius:5px; background-color:#cc0001 !important;">
                                              <div class="col-md-12 p-2 text-center">
                                                <b class="text-light">
                                                  <i class="fa fa-warning"></i> The Plumber reserves a right to access your house unit to assess the request made for proper and accurate procurement so that we may start the repair process.
                                                </b>
                                              </div>
                                            </div> <hr>
                                            <div class="card shadow">
                                                <div class="card-header" style="background-color: #00172A; color: #fff;">
                                                    <b>Make a Plumbing Issue Request</b>
                                                </div>
                                                <div class="card-body">
                                                    <div class="row">
                                                        <div class="col-md-12">
                                                    ...
                                                    <div class="card shadow" style="border:1px solid rgb(0,25,45,0.3); display:none;" id="secondSection">
                                                        ...
                                                        <div class="card-body">
                                                            <div class="form-group">
                                                                ...
                                                                <select class="form-control" name="plumbing_issue" id="plumbing_issue" required>
                                                    ...
                                                    <div class="card shadow" style="border:1px solid rgb(0,25,45, 0.3); display:none;" id="thirdSection" >
                                                        ...
                                                        <div class="card-body">
                                                            <div class="row p-2">
                                                                <div class="col-md-6 text-center">
                                                                    <div class="form-group">
                                                                        <div class="custom-control custom-switch">
                                                                            <input type="radio" class="custom-control-input" id="customSwitchAttachPhotos" name="plumbing_photos" value="Yes" onclick="displayToInsertPlumbingPhotos();" required>
                                                                ...
                                                                <div class="col-md-6 text-center">
                                                                    <div class="custom-control custom-switch">
                                                                        <input type="radio" class="custom-control-input" id="customSwitchNo" name="plumbing_photos" value="No" onclick="displayToHidePlumbingPhotos();" required>
                                                                        <label class="custom-control-label" for="customSwitchNo">No</label>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="card shadow" id="plumbingPhotosDiv" style="display: none; border:1px solid rgb(0, 25, 45, 0.3);">
                                                        ...
                                                        <div class="card-body p-1">
                                                            <div class="form-group p-3">
                                                                <div class="custom-control custom-switch">
                                                                    ...
                                                                    <label class="custom-control-label" for="customSwitchAuthorize"> I authorize the plumbing service provider to inspect and perform the requested services. Depending on the extent of the required service, I understand that additional charges may apply based on the final assessment.</label>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="card-footer text-right">
