<div class="card" id="outDoorRepairsRequestDetails" style="display: none;">
  <div class="card-header"><b>Outdoor Repairs Request Details</b></div>
  <form action="" method="post" enctype="multipart/form-data" autocomplete="off">
    <div class="card-body">
      ...
      <hr>
      <div class="form-group">
        <label>Ourdoor Repairs Issue</label>
      ...
      <div class="form-group">
        ...
        <textarea name="outdoor_desc" id="outdoor_desc" class="form-control" required placeholder="Write a brief Description of your Request Here"></textarea>
        <b class="text-danger mt-2" id="outdoorDescError"></b>
      </div>
      <div class="row">
        <div class="col-md-6">
          <div class="form-group">
            <label>Urgence Level</label>
            <select name="outdoor_urgphp
            ence" id="outdoor_urgence" class="form-control">
            ...
            <b class="text-danger mt-2" id="outdoorUrgencyError"></b>
          </div>
        </div>
        <div class="col-md-6">
          <div class="form-group">
      ...
      <div class="row">
        ...
        <div class="col-md-6 text-center">
          <div class="form-group">
            <div class="custom-control custom-switch">
              <input type="radio" class="custom-control-input" id="customSwitchAttachOutdoorPhotos"
              name="outdoor_photos" value="Yes" onclick="displayToInsertOutdoorPhotos();" required>
              <label class="custom-control-label" for="customSwitchAttachOutdoorPhotos">
              Yes</label>
            </div>
          </div>
        </div>
        <div class="col-md-6 text-center">
          <div class="custom-control custom-switch">
            <input type="radio" class="custom-control-input" id="customOutdoorSwitchNo" name="outdoor_photos"
            value="No" onclick="displayToHideOutdoorPhotos();" required>
            <label class="custom-control-label" for="customOutdoorSwitchNo">
            No</label>
          </div>
        </div>
      </div>
      <div class="card" id="outdoorPhotosDiv" style="display: none;">
              ...
              <div class="form-group">
                ...
                <div class="input-group">
                  <div class="custom-file">
                    <input type="file" class="custom-file-input" id="exampleInputFile" name="outdoor_photo_one">
      ...
      <div class="form-group">
        <div class="custom-control custom-switch">
          <input type="radio" class="custom-control-input" id="customOutdoorSwitchAuthorize" name="terms_conditions"
          value="Confirm Authorization">
          <label class="custom-control-label" for="customApplianceSwitchAuthorize"> I authorize the
            Outdoor Repair and Maintenance service provider to inspect and perform the
    ...
    <div class="card-footer text-right">
      <button type="button" class="btn btn-sm text-light" style="background-color: #cc0001;" data-dismiss="modal"><i
        ...
        id="confirmOutdoorRequest"><i class="fa fa-check"></i>
        <b>Submit</b></button>
      </div>
    </form>
  </div>