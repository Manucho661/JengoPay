<div class="card" id="pestRequestDetails" style="display: none;">
    <div class="card-header"><b>Pest Control Request Details</b></div>
    <form action="" method="post" enctype="multipart/form-data" autocomplete="off">
        <div class="card-body">
            <div class="row">
                <div class="col-md-12">
                    <div class="form-group">
                        <input type="hidden" class="form-control" name="pest_control" value="Pest Control">
                    </div>
                </div>
            </div>
            <div class="row">
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <b class="text-danger mt-2" id="pestUrgencyError"></b>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
            ...
            <div class="row">
                ...
                <div class="col-md-6 text-center">
                    <div class="form-group">
                        <div class="custom-control custom-switch">
                            <input type="radio" class="custom-control-input" id="customSwitchAttachPestPhotos"
                                name="pest_photos" value="Yes" onclick="displayToInsertPestPhotos();"
                                required>
                            <label class="custom-control-label" for="customSwitchAttachPestPhotos">
                                Yes</label>
                        </div>
                    </div>
                </div>
                <div class="col-md-6 text-center">
                    <div class="custom-control custom-switch">
                        <input type="radio" class="custom-control-input" id="customPestSwitchNo"
                            name="pest_photos" value="No" onclick="displayToHidePestPhotos();" required>
                        <label class="custom-control-label" for="customPestSwitchNo">
                            No</label>
                    </div>
                </div>
            </div>
            <div class="card" id="pestPhotosDiv" style="display: none;">
            ...
            <div class="form-group">
                <div class="custom-control custom-switch">
                    <input type="radio" class="custom-control-input" id="customPestSwitchAuthorize"
                        name="terms_conditions" value="Confirm Authorization">
                    <label class="custom-control-label" for="customPestSwitchAuthorize"> I authorize the
                        Pest service provider to inspect and perform the
        ...
        <div class="card-footer text-right">
            ...
            <button type="submit" class="btn btn-sm" style="background-color: #00192D; color:#fff;"
                id="confirmPestRequest"><i class="fa fa-check"></i>
                <b>Submit</b></button>
        </div>
    </form>
</div>