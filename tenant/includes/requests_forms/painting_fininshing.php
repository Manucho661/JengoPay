<div class="card" id="painitngFinishingRequestDetails" style="display: none;">
  <div class="card-header"><b>Painting and Finishing</b></div>
  <form action="" method="post" enctype="multipart/form-data" autocomplete="off">
    <div class="card-body">
      <div class="row">
        <div class="col-md-12">
          <div class="form-group">
            <input type="hidden" class="form-control" name="painting_finishing" value="Painitnd and Finishing">
          </div>
        </div>
      </div>
      <div class="row">
      ...
      <hr>
      <div class="form-group">
        <label>Painting and Finishing Issue</label>
        <select class="form-control" name="paintfinish_issue" id="paintfinish_issue">
          <option value="" hidden selected>-- Select Option --</option>
          <option>Repainting</option>
          <option>Tounching Up</option>
        </select>
        <b class="text-danger mt-2" id="paintfinishIssueError"></b>
      </div>
      <div class="form-group">
        <label>Detailed Description</label> <sup class="text-danger"><b>*</b></sup>
        <textarea name="paintfinish_desc" id="paintfinish_desc" class="form-control" required
          placeholder="Write a brief Description of your Request Here"></textarea>
        <b class="text-danger mt-2" id="paintfinishDescError"></b>
      </div>
      <div class="row">
        <div class="col-md-6">
          <div class="form-group">
            <label>Urgence Level</label>
            <select name="paintfinish_urgence" id="paintfinish_urgence" class="form-control">
            ...
            <b class="text-danger mt-2" id="paintfinishUrgencyError"></b>
          </div>
        </div>
        <div class="col-md-6">
          <div class="form-group">
      ...
      <div class="row">
        ...
        <div class="col-md-6 text-center">
          <div class="form-group">
            <div class="custom-control custom-switch">
              <input type="radio" class="custom-control-input" id="customSwitchAttachPaintFinishPhotos"
                name="paintfinish_photos" value="Yes" onclick="displayToInsertPaintFinishPhotos();" required>
              <label class="custom-control-label" for="customSwitchAttachPaintFinishPhotos">
                Yes</label>
            </div>
          </div>
        </div>
        <div class="col-md-6 text-center">
          <div class="custom-control custom-switch">
            <input type="radio" class="custom-control-input" id="customPaintFinishSwitchNo" name="paintfinish_photos"
              value="No" onclick="displayToHidePaintFinishPhotos();" required>
            <label class="custom-control-label" for="customPaintFinishSwitchNo">
              No</label>
          </div>
        </div>
      </div>
      <div class="card" id="paintfinishPhotosDiv" style="display: none;">
              ...
              <div class="form-group">
                ...
                <div class="input-group">
                  <div class="custom-file">
                    <input type="file" class="custom-file-input" id="exampleInputFile" name="paintfinish_photo_one">
      ...
      <div class="form-group">
        <div class="custom-control custom-switch">
          <input type="radio" class="custom-control-input" id="customPaintFinishSwitchAuthorize" name="terms_conditions"
            value="Confirm Authorization">
          <label class="custom-control-label" for="customPaintFinishSwitchAuthorize"> I authorize the
            Painting and Finishing service provider to inspect and perform the
    ...
    <div class="card-footer text-right">
      ...
      <button type="submit" class="btn btn-sm" style="background-color: #00192D; color:#fff;"
        id="confirmPaintFinishRequest"><i class="fa fa-check"></i>
        <b>Submit</b></button>
    </div>
  </form>
</div>
