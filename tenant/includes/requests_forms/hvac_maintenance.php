<div class="card" id="hvacRequestDetails" style="display: none;">
  <div class="card-header"><b>HVAC Maintenance Request Details</b></div>
  <form action="" method="post" enctype="multipart/form-data" autocomplete="off">
    <div class="card-body">
      <div class="row">
        <div class="col-md-12">
          <div class="form-group">
            <input type="hidden" class="form-control" name="hvac_repairs" value="HVAC Maintenance">
          </div>
        </div>
      </div>
      <div class="row">
      ...
      <hr>
      <div class="form-group">
        <label>HVAC Maintenance Issue</label>
      ...
      <div class="form-group">
        ...
        <b class="text-danger mt-2" id="hvacDescError"></b>
      </div>
      <div class="row">
        <div class="col-md-6">
          <div class="form-group">
            ...
            <b class="text-danger mt-2" id="hvacUrgencyError"></b>
          </div>
        </div>
        <div class="col-md-6">
          <div class="form-group">
      ...
      <div class="row">
        ...
        <div class="col-md-6 text-center">
          <div class="form-group">
            <div class="custom-control custom-switch">
              <input type="radio" class="custom-control-input" id="customSwitchAttachHvacPhotos"
                name="hvac_photos" value="Yes" onclick="displayToInsertHvacPhotos();" required>
              <label class="custom-control-label" for="customSwitchAttachHvacPhotos">
                Yes</label>
            </div>
          </div>
        </div>
        <div class="col-md-6 text-center">
          <div class="custom-control custom-switch">
            <input type="radio" class="custom-control-input" id="customHvacSwitchNo" name="hvac_photos"
              value="No" onclick="displayToHideHvacPhotos();" required>
            <label class="custom-control-label" for="customHvacSwitchNo">
              No</label>
          </div>
        </div>
      </div>
      <div class="card" id="hvacPhotosDiv" style="display: none;">
              ...
              <div class="form-group">
                ...
                <div class="input-group">
                  <div class="custom-file">
                    <input type="file" class="custom-file-input" id="exampleInputFile" name="hvac_photo_one">
      ...
      <div class="form-group">
        <div class="custom-control custom-switch">
          <input type="radio" class="custom-control-input" id="customHvacSwitchAuthorize" name="terms_conditions"
            value="Confirm Authorization">
          <label class="custom-control-label" for="customHvacSwitchAuthorize"> I authorize the
            HVAC service provider to inspect and perform the
    ...
    <div class="card-footer text-right">
      ...
      <button type="submit" class="btn btn-sm" style="background-color: #00192D; color:#fff;"
        id="confirmHvacRequest"><i class="fa fa-check"></i>
        <b>Submit</b></button>
    </div>
  </form>
</div>