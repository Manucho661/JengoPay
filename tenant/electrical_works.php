            ...
            <div class="content-wrapper">
                ...
                <section class="content">
                    <div class="container-fluid">
                        ...
                        <div class="modal fade shadow" id="submitRequest" style="overflow-y: scroll; height: 700px;">
                                        ...
                                        <div class="modal-body">
                                            <div class="row bg-danger" style="border-radius:5px; background-color:#cc0001 !important;">
                                                <div class="col-md-12 p-2 text-center">
                                                    <b class="text-light">
                                                        <i class="fa fa-warning"></i> The Electrician reserves a right to access your house unit
                                                        to assess the request made for proper and accurate procurement so that we may start the repair
                                                        process.
                                                    </b>
                                                </div>
                                            </div> <hr>
                                            <div class="card shadow">
                                                <div class="card-header" style="background-color: #00172A; color: #fff;">
                                                    <b>Make a Electrical Issue Request</b>
                                                </div>
                                                <div class="card-body">
                                                    <div class="row">
                                                        <div class="col-md-12">
                                                            <div class="form-group">
                                                                <input type="hidden" class="form-control" name="electrical_repairs" value="Electrical Works">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="card shadow" style="border:1px solid rgb(0,25,45,0.3); display:none;" id="secondSection">
                                                        <div class="card-header" style="background-color:rgb(0,25,45); color:#fff;">
                                                            <b>Electrical Issue</b>
                                                        </div>
                                                        <div class="card-body">
                                                            <div class="form-group">
                                                                <label>Electrical Issue</label>
                                                                <select class="form-control" name="electrical_issue" id="electrical_issue" required>
                                                                    <option value="" hidden selected>-- Select Option --</option>
                                                                    <option>Outlets and Switches</option>
                                                                    <option>Lighting</option>
                                                                    <option>Frequent Power Shortages</option>
                                                                    <option>Circuit Breakers</option>
                                                                    <option>Transformer Issues</option>
                                                                    <option>Electical Shocks</option>
                                                                    <option>Faulty Swithches</option>
                                                                    <option>Exposed Wiring</option>
                                                                    <option>High Energy Bills</option>
                                                                    <option>Other</option>
                                                                </select>
                                                                <b class="text-danger mt-2" id="electricalIssueError"></b>
                                                            </div>
                                                            <div class="form-group">
                                                                <label>Detailed Description</label> <sup class="text-danger"><b>*</b></sup>
                                                                <textarea name="electrical_desc" id="electrical_desc" class="form-control" required
                                                                          placeholder="Write a brief Description of your Request Here"></textarea>
                                                                <b class="text-danger mt-2" id="electricalDescError"></b>
                                                            </div>
                                                            <div class="row">
                                                                <div class="col-md-6">
                                                                    <div class="form-group">
                                                                        <label>Urgence Level</label>
                                                                        <select name="electrical_urgence" id="electrical_urgence" class="form-control">
                                                                        ...
                                                                        <b class="text-danger mt-2" id="electricalUrgencyError"></b>
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-6">
                                                                    <div class="form-group">
                                                    ...
                                                    <div class="card shadow" style="border:1px solid rgb(0,25,45, 0.3); display: none;" id="thirdSection">
                                                        ...
                                                        <div class="card-body">
                                                            <div class="row p-2">
                                                                <div class="col-md-6 text-center">
                                                                    <div class="form-group">
                                                                        <div class="custom-control custom-switch">
                                                                            <input type="radio" class="custom-control-input" id="customSwitchAttachPhotos" name="electrical_photos" value="Yes" onclick="displayToInsertElectricalgPhotos();" required>
                                                                ...
                                                                <div class="col-md-6 text-center">
                                                                    <div class="custom-control custom-switch">
                                                                        <input type="radio" class="custom-control-input" id="customSwitchNo" name="electrical_photos"
                                                                               value="No" onclick="displayToHideElectricalPhotos();" required>
                                                                        <label class="custom-control-label" for="customSwitchNo">
                                                                            No</label>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="card shadow" id="electricalsPhotosDiv" style="display: none; border:1px solid rgb(0, 25, 45, 0.3);">
                                                    ...
                                                    <div class="card shadow" style="border:1px solid rgb(0, 25, 45, 0.3); border-radius:3px; display:none;" id="fourthSection">
                                                        ...
                                                        <div class="card-body p-1">
                                                            <div class="form-group p-3">
                                                                <div class="custom-control custom-switch">
                                                                    <input type="radio" class="custom-control-input" id="customSwitchAuthorize" name="authorize_plumber" value="Confirm Authorization">
                                                                    <label class="custom-control-label" for="customSwitchAuthorize"> I authorize the Electrical service provider to inspect and perform the requested services. Depending on the extent of the required service, I understand that additional charges may apply based on the final assessment.</label>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="card-footer text-right">
                                                            <button type="button" class="btn btn-sm" style="background-color: #cc0001; color: #fff;" id="fourthSectionBackBtn">Go Back</button>
                                                            <button type="submit" class="btn btn-sm" style="background-color: #00172A; color: #fff;">Submit</button>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
