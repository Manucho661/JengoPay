                                        ...
                                        <div class="modal-body">
                                           <div class="row bg-danger" style="border-radius:5px; background-color:#cc0001 !important;">
                                              <div class="col-md-12 p-2 text-center">
                                                <b class="text-light">
                                                  <i class="fa fa-warning"></i> The Painter reserves a right to access your house unit to assess the request made for proper and accurate procurement so that we may start the eradication process.
                                                </b>
                                              </div>
                                            </div> <hr>
                                            <div class="card shadow">
                                                <div class="card-header" style="background-color: #00172A; color: #fff;">
                                                    <b>Make a Paint Issue Request</b>
                                                </div>
                                                <div class="card-body">
                                                    <div class="row">
                                                        <div class="col-md-12">
                                                            <div class="form-group">
                                                                <input type="hidden" class="form-control" name="paint_issue" value="Paint Issue">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="card shadow" style="border:1px solid rgb(0,25,45,0.3); display:none;" id="secondSection" >
                                                        <div class="card-header" style="background-color:rgb(0,25,45); color:#fff;">
                                                            <b>Paint and Finishing Issue</b>
                                                        </div>
                                                        <div class="card-body">
                                                            <div class="form-group">
                                                                <label>Paint and Finishing Issue</label>
                                                                <select class="form-control" name="paint_issue" id="paint_issue">
                                                                  <option value="" hidden selected>-- Select Option --</option>
                                                                  <option>Repainting</option>
                                                                  <option>Toucing Up</option>
                                                                </select>
                                                                <b class="text-danger mt-2" id="paintIssueError"></b>
                                                            </div>
                                                            <div class="form-group">
                                                                <label>Detailed Description</label> <sup class="text-danger"><b>*</b></sup>
                                                                <textarea name="paint_desc" id="paint_desc" class="form-control" required
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-6">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <select name="paint_urgence" id="paint_urgence" class="form-control">
                                                                        ...
                                                                        <b class="text-danger mt-2" id="paintcUrgenceError"></b>
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-6">
                                                                    <div class="form-group">
                                                    ...
                                                    <div class="card shadow" style="border:1px solid rgb(0,25,45, 0.3); display:none;" id="thirdSection">
                                                        ...
                                                        <div class="card-body">
                                                            <div class="row p-2">
                                                                <div class="col-md-6 text-center">
                                                                    <div class="form-group">
                                                                        <div class="custom-control custom-switch">
                                                                            <input type="radio" class="custom-control-input" id="customSwitchAttachPhotos" name="paint_photos" value="Yes" onclick="displayToInsertPaintFinishPhotos();" required>
                                                                ...
                                                                <div class="col-md-6 text-center">
                                                                    <div class="custom-control custom-switch">
                                                                        <input type="radio" class="custom-control-input" id="customSwitchNo" name="paint_photos" value="No" onclick="displayToHidePaintFinishPhotos();" required>
                                                                        <label class="custom-control-label" for="customSwitchNo">No</label>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="card shadow" id="paintfinishPhotosDiv" style="display: none; border:1px solid rgb(0, 25, 45, 0.3);">
                                                    ...
                                                    <div class="card shadow" style="border:1px solid rgb(0, 25, 45, 0.3); border-radius:3px; display:none;" id="fourthSection">
                                                        ...
                                                        <div class="card-body p-1">
                                                            <div class="form-group p-3">
                                                                <div class="custom-control custom-switch">
                                                                    <input type="radio" class="custom-control-input" id="customSwitchAuthorize" name="authorize_painter_provider" value="Confirm Authorization">
                                                                    <label class="custom-control-label" for="customSwitchAuthorize"> I authorize the Paint and Finishing Service provider to inspect and perform the requested services. Depending on the extent of the required service, I understand that additional charges may apply based on the final assessment.</label>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="card-footer text-right">
