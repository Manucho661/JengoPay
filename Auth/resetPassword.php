            ...
            <div class="w-full max-w-md h-full fade-in">
                ...
                <div id="FormSection">
                    <form id="resetPasswordForm" class="space-y-6">
                        ...
                        <div class="text-red-400 text-sm italic" id="incorretDetailsErrorMessage"></div>
                        ...
                        <p class="text-center text-gray-600 text-sm mt-6">
                            ...
                            <br>
                            <a href="registerLandlord.php" class="text-yellow-500 hover:text-yellow-600 font-semibold">1. As a Landlord <span class="text-gray-500">or</span></a>
                            <br>
                            <a href="registerProvider.php" class="text-yellow-500 hover:text-yellow-600 font-semibold">2. As a Provider</a>
                        </p>
                    </form>
                </div>
            </div>
