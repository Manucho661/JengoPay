        ...
        <div class="job-card">
          <div class="d-flex justify-content-between">
            <div style="width: 100%;">
              ...
              <p class="mt-2 job-description">
                Looking for a front-end dev to create a sleek landing page for our SaaS tool. The landing page should be mobile responsive, fast loading, and optimized for conversion. Familiarity with modern UI principles is a must. Experience in SEO is a plus. Candidate should deliver within 5 days with full source code.
              </p>
            </div>
        ...
        <div class="job-card">
          <div class="d-flex justify-content-between">
            <div style="width: 100%;">
              ...
              <p class="mt-2 job-description">
                We need someone to build an internal dashboard to manage user analytics and feedback, create real-time charts, integrate third-party APIs, and support authentication through Firebase. Experience with Docker, CI/CD pipelines, and cloud infrastructure is a bonus. The dashboard should be clean, mobile responsive, and fast.
              </p>
            </div>
            <div class="text-end" style="white-space: nowrap;">
              <button class="btn btn-outline-primary">Apply</button>
