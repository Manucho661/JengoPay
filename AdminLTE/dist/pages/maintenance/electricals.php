              ...
              <div class="modal-dialog modal-lg modal-dialog-centered">
                <div class="modal-content rounded-2 shadow">
                  ...
                  <div class="modal-header bg-dark text-white rounded-top-2">
                    <h5 class="modal-title" id="maintenanceRequestModalLabel" style="color: #FFA000 !important;">🛠 Maintenance Request Details</h5>
                    <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal" aria-label="Close"></button>
                  </div>
                  ...
                  <div class="modal-body p-4">
                    ...
                    <div class="mb-4 text-center">
                      <img id="request-imag" src="uploads/Spoiled_floor.jpg" alt="Maintenance Picture" class="img-fluid rounded-3 shadow-sm" style="max-height: 150px; object-fit: cover;">
                    </div>
              ...
              <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content shadow-lg border-0 rounded-3">
                  ...
                  <div class="modal-header" style="background-color: #00192D;">
                    <h5 class="modal-title" id="assignProviderModalLabel" style="color: #FFA000 !important;" >
                  ...
                  <!-- Modal Form -->
                  <form id="assignProviderForm" onsubmit="assignProvider(event)" >
                    <div class="modal-body">
