...
<head>
  ...
  <link rel="stylesheet" href="../../../../landlord/css/adminlte.css" />  <!-- <link rel="stylesheet" href="text.css" /> -->
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
      document.getElementById('saveDraftBtn').addEventListener('click', function() {
        ...
        fetch('/Jengopay/landlord/pages/communications/announcements/actions/save_draft.php', {
            method: 'POST',
            headers: {
  ...
  document.addEventListener('DOMContentLoaded', function() {
    ...
    document.getElementById('saveDraftChanges').addEventListener('click', async function() {
        ...
        try {
            ...
            // Send update request
            const response = await fetch('/Jengopay/landlord/pages/communications/announcements/actions/update_draft.php', {
                method: 'POST',
                headers: {
...
<script>
  function restoreAllArchived() {
    if (confirm("Restore all archived announcements?")) {
      fetch('/Jengopay/landlord/pages/communications/announcements/actions/restore_all.php', { method: 'POST' })
        .then(res => res.json())
        .then(data => {
...
<script>
  ...
  fetch('/Jengopay/landlord/pages/communications/announcements/actions/announcing_count.php')
    .then(res => res.json())
    .then(data => {
      if (data.success) {
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  <script>
    function showArchivedMessages() {
      fetch('/Jengopay/landlord/pages/communications/announcements/actions/get_archived_messages.php')
        .then(response => response.json())
        .then(data => {
    ...
    function restoreAnnouncement(id) {
      fetch('/Jengopay/landlord/pages/communications/announcements/actions/restore_message.php', {
          method: 'POST',
          headers: {
            'Content-Type': 'application/x-www-form-urlencoded',
          },
    ...
    function deleteAnnouncement(id) {
      fetch('/Jengopay/landlord/pages/communications/announcements/actions/delete_message.php', {
          method: 'POST',
          headers: {
            'Content-Type': 'application/x-www-form-urlencoded',
          },
...
function showDrafts() {
  fetch('/Jengopay/landlord/pages/communications/announcements/actions/get_drafts.php')
    .then(response => response.json())
    .then(data => {
      const container = document.getElementById('announcementList');
      container.innerHTML = '';
...
function showEditModal(draftId) {
  // Fetch draft details
  fetch(`/Jengopay/landlord/pages/communications/announcements/actions/get_draft_details.php?id=${draftId}`)
    .then(response => response.json())
    .then(draft => {
      if (draft) {
...
document.getElementById('saveDraftChanges').addEventListener('click', function() {
  ...
  fetch('/Jengopay/landlord/pages/communications/announcements/actions/update_draft.php', {
    method: 'POST',
    body: formData
  })
  .then(response => response.json())
...
function deleteDraft(draftId) {
  ...
  fetch('/Jengopay/landlord/pages/communications/announcements/actions/delete_draft.php', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/x-www-form-urlencoded',
    },
...
<script>
  async function showEditModal(draftId) {
    try {
        ...
        // Fetch draft data
        const response = await fetch(`/Jengopay/landlord/pages/communications/announcements/actions/get_draft_details.php?id=${draftId}`);
        const result = await response.json();
...
// </script>
  ...
  <script>
    function loadDraft(draftId) {
      fetch(`/Jengopay/landlord/pages/communications/announcements/actions/get_draft_by_id.php?id=${draftId}`)
        .then(response => response.json())
        .then(data => {
...
<script>
 function showSentMessages() {
  fetch('/Jengopay/landlord/pages/communications/announcements/actions/get_sent_messages.php')
    .then(response => {
...
function deleteAnnouncement(id) {
  fetch('/Jengopay/landlord/pages/communications/announcements/actions/delete_sent_message.php', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/x-www-form-urlencoded',
    },
...
function archiveAnnouncement(id) {
  fetch('/Jengopay/landlord/pages/communications/announcements/actions/archive_sent_message.php', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/x-www-form-urlencoded',
    },
...
<script>
  ...
  fetch(`/Jengopay/landlord/pages/communications/announcements/actions/fetch_announcements.php?building_id=${encodeURIComponent(recipient)}`)
    .then(res => res.json())
    .then(data => {
      const container = document.getElementById('announcementList');
      container.innerHTML = '';
  ...
  function loadAnnouncements() {
    fetch('/Jengopay/landlord/pages/communications/announcements/actions/fetch_announcements.php')
      .then(response => response.json())
      .then(data => {
  ...
  function archiveAnnouncement(id) {
    fetch('/Jengopay/landlord/pages/communications/announcements/actions/archive_message.php', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/x-www-form-urlencoded',
        },
  ...
  <script>
    function fetchAnnouncementCounts() {
      fetch('/Jengopay/landlord/pages/communications/announcements/actions/get_announcement_counts.php')
        .then(response => response.json())
        .then(data => {
          if (data.success) {
            document.getElementById('sentCount').textContent = data.sent;
...
function sendMessage() {
  ...
  fetch('/Jengopay/landlord/pages/communications/announcements/actions/send_announcement.php', {
    method: 'POST',
    body: formData
  })
  .then(response => response.json())
