                                ...
                                <div class="card-body p-0">
                                    ...
                                    <?php if (!empty($units)): ?>
                                        ...
                                        <div class="table-responsive">
                                                ...
                                                <tbody>
                                                    <?php foreach ($units as $unit): ?>
                                                        <tr>
                                                            ...
                                                            <td>KES <?= number_format($unit['monthly_rent']) ?></td>
                                                            <td>
                                                            ...
                                                            <td>Emmanuel</td>
                                                            <td>
                                                                <button class="action-btn view-btn mb-1">
                                            ...
                                            <button class="btn bg-warning w-100 mt-2">View All units</button>
                                        </div>
                                    ...
                                    <?php else: ?>
                                        ...
                                        <div class="text-center py-5 px-3">
                                            ...
                                            <h6 class="fw-bold mb-2">No Units Available Yet</h6>

                                            <p class="text-muted mb-3">
                                                This building doesn’t have any units added yet.
                                                Add your first unit to start managing tenants,
                                                rent, and occupancy.
                                            </p>

                                            <!-- Add Unit Button (only here when empty) -->
                                            <button class="btn btn-success"
                                                data-bs-toggle="modal"
                                                data-bs-target="#addUnitModal">
                                ...
                                <div class="card-body">
                                    ...
                                    <?php else: ?>
                                        <div class="text-center py-5 px-3">
                                            ...
                                            <h6 class="fw-bold mb-2">No requests Available Yet</h6>

                                            <p class="text-muted mb-3">
                                                This building doesn’t have no requests registered.
                                            </p>
                                        </div>
