  ...
  try {
    if (!empty($id)) {
      $sql = "
        ...
        INNER JOIN unit_categories uc ON bu.unit_category_id = uc.id
        WHERE bu.id = :id
        LIMIT 1
    ";
      ...
      if ($row) {
        ...
        $building_name = $row['building_name'];         // from buildings
        $category_name = $row['category_name']; // from unit_categories
        $purpose = $row['purpose'];
...
// actions
require_once "./actions/units/rent_single_unit.php";
        ...
        <section class="content">
          <div class="container-fluid">
            ...
            ";
                ...
                // Handle error
                echo "Error fetching unit: " . $e->getMessage();
              }
            }
            ?>
