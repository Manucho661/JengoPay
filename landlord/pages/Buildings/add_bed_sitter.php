...
// actions
require_once "./actions/units/add_bed_sitter_unit.php";
?>
        ...
        <main class="main">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb" style="">
                    ...
                    <li class="breadcrumb-item active">Add bedsitter unit</li>
                </ol>
            </nav>
                ...
                <div class="row">
                    ...
                    <div class="row align-items-center mb-4">
                        <div class="col-12 d-flex align-items-center">
                            ...
                            <h3 class="mb-0 ms-3">Add a bed sitter unit</h3>
                    ...
                    <div class="col-md-3 col-sm-6 col-12">
                        <div class="stat-card d-flex align-items-center rounded-2 p-1">
                            <div>
                                <i class="bi bi-building me-3 text-warning"></i>
                            </div>
                            <div>
                    ...
                    <div class="col-md-3 col-sm-6 col-12">
                        <div class="stat-card d-flex align-items-center rounded-2 p-1">
                            <div>
                                <i class="bi bi-houses me-3 text-warning"></i>
                            </div>
                            <div>
                    ...
                    <div class="col-md-3 col-sm-6 col-12">
                        <div class="stat-card d-flex align-items-center rounded-2 p-1">
                            <div>
                                <i class="bi bi-house-exclamation me-3 text-warning"></i>
                            </div>
                            <div>
                    ...
                    <div class="col-md-3 col-sm-6 col-12">
                        <div class="stat-card d-flex align-items-center rounded-2 p-1">
                            <div>
                                <i class="bi bi-table me-3 text-warning"></i>
                            </div>
                            <div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="card shadow" id="secondSection" style="border:1px solid rgb(0,25,45,.2); display:none;">
                                ...
                                <div class="card-footer text-right">
                                    ...
                                    <button class="btn btn-sm" type="submit" name="submit_unit" style="background-color:#00192D; color: #fff;"><i class="bi bi-send"></i> </button>
                                </div>
                            </div>
                    </form>
                </div>
