        ...
        <div class="content-wrapper">
            ...
            <section class="content">
                ...
                if (isset($_POST['submit_building'])) {
                    ...
                    try {
                        $sql = "INSERT INTO buildings (building_name, county, constituency, ward, structure_type, floors_no, no_of_units, building_type, tax_rate, ownership_info, first_name, last_name, id_number, primary_contact, other_contact, owner_email, postal_address, entity_name, entity_phone, entity_phoneother, entity_email, entity_rep, rep_role, entity_postal, ownership_proof, title_deed, legal_document, amenities, photo_one, photo_two, photo_three, photo_four, confirm) VALUES (:building_name, :county, :constituency, :ward, :structure_type, :floors_no, :no_of_units, :building_type, :tax_rate, :ownership_info, :first_name, :last_name, :id_number, :primary_contact, :other_contact, :owner_email, :postal_address, :entity_name, :entity_phone, :entity_phoneother, :entity_email, :entity_rep, :rep_role, :entity_postal, :ownership_proof, :title_deed, :legal_document, :amenities, :photo_one, :photo_two, :photo_three, :photo_four, :confirm)";
                                ...
                                <div class="modal-dialog modal-lg">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form id="buildingForm" method="POST" enctype="multipart/form-data" onsubmit="return confirmSubmit();">
                                                <!-- First Section -->
                    ...
                    <!-- Add Units Confirmation Sweet Alerts -->
                    <script>
