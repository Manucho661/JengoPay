...
<div class="form-popup shadow" id="helpForm">
    <div class="form-container">
      ...
      <form action="" method="post" autocomplete="off">
        <div class="row" style="background-color:#fff; border-radius: 7px;">
          <div class="col-md-9">
            <input class="form-control mt-2" name="search_msg" placeholder="Type your Message Here..." required style="height:40px !important; border-radius: 0 !important;" data-toggle="tooltip" title="Type your Message Here and We'll get back to you">
          </div>
          <div class="col-md-3">
            <button class="btn btn-sm p-2 mt-2" style="height:40px !important; border:1px solid; background-color:#00192D; color:#fff;">Submit</button>
          </div>
        </div>
      </form>
