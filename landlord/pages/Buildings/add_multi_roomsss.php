...
<body class="hold-transition sidebar-mini">
    ...
    try {
        ...
        $check = $conn->prepare("SELECT COUNT(*) FROM multi_rooms WHERE unit_number = :unit_number AND building_link = :building_link");
        $check->execute([
        ...
        $stmt = $conn->prepare("INSERT INTO multi_rooms 
        ...
        if (!empty($_POST['bill'])) {
            $stmtBill = $conn->prepare("INSERT INTO multi_roombills (unit_id, bill, qty, unit_price, subtotal, created_at) 
