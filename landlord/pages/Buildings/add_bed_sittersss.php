                        ...
                        <?php
                            ...
                            echo "<script>
                                ...
                                if(isset($_POST['submit_unit'])) {
                                    ...
                                    try{
                                        $check = $conn->prepare("SELECT COUNT(*) FROM bed_seaters WHERE unit_number = :unit_number AND building_link = :building_link");
                                        $check->execute([
                                        ...
                                        $stmt = $conn->prepare("INSERT INTO bed_seaters (structure_type, first_name, last_name, owner_email, entity_name, entity_phone, entity_phoneother, entity_email, unit_number, purpose, building_link, location, water_meter, monthly_rent, occupancy_status, created_at) VALUES (:structure_type, :first_name, :last_name, :owner_email, :entity_name, :entity_phone, :entity_phoneother, :entity_email, :unit_number, :purpose, :building_link, :location, :water_meter, :monthly_rent, :occupancy_status, NOW())");
                                        ...
                                        if (!empty($_POST['bill'])) {
                                            $stmtBill = $conn->prepare("INSERT INTO bed_seater_bills (unit_id, bill, qty, unit_price, subtotal, created_at) VALUES (:unit_id, :bill, :qty, :unit_price, :subtotal, NOW())");
