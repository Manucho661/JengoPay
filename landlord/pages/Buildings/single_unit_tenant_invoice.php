...
<head>
    ...
    <style>
        ...
        .offcanvas-backdrop {
            ...
            pointer-events: none;
            /* Allows clicks through when not visible */
        }
                            ...
                            <table id="invoiceTable" class="table table-bordered table-striped">
                                ...
                                <tfoot>
                                    ...
                                    <tr>
                                        ...
                                        <td id="totalTax" class="text-end">0.00</td>
                                        <td></td>
                                    </tr>
                                    <tr>
                                        <td colspan="6" class="text-end"><strong>Final Total:</strong></td>
                                        <td id="finalTotal" class="text-end">0.00</td>
                                        <td></td>
                                    </tr>
                                </tfoot>
                            </table>
