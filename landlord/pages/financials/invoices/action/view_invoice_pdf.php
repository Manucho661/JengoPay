...
while ($item = $itemsStmt->fetch(PDO::FETCH_ASSOC)) {
    ...
    $lineRows .= '
        <tr style="height:35px;">
            <td width="16.7%" style="border: 1px solid #FFC107; padding: 6px;">'
                .htmlspecialchars($item['description']).'</td>
            <td width="16.7%" style="border: 1px solid #FFC107; text-align: right; padding: 6px;">'
                .$qty.'</td>
            <td width="16.7%" style="border: 1px solid #FFC107; text-align: right; padding: 6px;">KES '
...
$paymentText   = match ($paymentStatus) {
    ...
    'partial' => '<span style="color: orange; font-weight: bold;">PARTIALLY PAID</span>',
    default   => '<span style="color: red; font-weight: bold;">UNPAID</span>'
};
...
<style>
    ...
    .table td { padding: 5px; border: 1px solid #FFC107; font-size: small; }
    .text-end { text-align: right; }
    .total-row { font-weight: bold; }
    .info-box { background-color: #f0f0f0; padding: 10px; border-radius: 8px; font-size: 11px; }
    .date-box { border: 1px solid #FFC107; background-color: #FFF4CC; border-radius: 8px; font-size: 11px; }
</style>

<!-- Header (Logo, Company Info, Payment Status) -->
<table width="100%" style="margin-bottom: 10px;">
    <tr>
        <td width="33%">
            <img src="expenseLogo6.png" alt="JengoPay Logo" style="height: 80px;">
        </td>
...
<table width="100%" style="margin-top: 10px;">
    <tr>
        <td width="50%" style="line-height: 1.4; font-size: 11px;">
            <strong>'.htmlspecialchars($inv['tenant_name']).'</strong><br>
            '.htmlspecialchars($inv['tenant_email']).'<br>
            '.htmlspecialchars($inv['tenant_phone']).'<br>
            <strong>B20</strong>
        </td>
...
<table width="100%" style="margin: 10px 0;">
    <tr>
        <td width="100%">
            <div class="date-box" style="padding: 8px;">
                <table width="100%">
                    <tr>
                        <td width="50%">
...
<table class="table">
    <thead>
        <tr>
            <th width="16.7%">Description</th>
            <th width="16.7%" class="text-end">Qty</th>
            <th width="16.7%" class="text-end">Unit Price</th>
            <th width="16.7%" class="text-end">VAT</th>
            <th width="16.7%" class="text-end">Taxes</th>
            <th width="16.7%" class="text-end">Total</th>
        </tr>
    </thead>
    <tbody>
        '.$lineRows.'
