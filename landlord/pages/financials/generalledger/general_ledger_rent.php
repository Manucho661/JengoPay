...
// Force account_id to be '500' for Rent
$account_id = '500';
...
// Always filter for Rent account (account code '500')
$where[] = "jl.account_id = :account_id";
$params[':account_id'] = $account_id;

$whereSql = $where ? "WHERE " . implode(" AND ", $where) : "";

// General Ledger query for Rent only
$sql = "
    SELECT 
        je.created_at,
        je.reference,
...
// Get Rent account name for title
$rentAccount = $pdo->prepare("SELECT account_name FROM chart_of_accounts WHERE account_code = ?");
$rentAccount->execute([$account_id]);
$rentAccountName = $rentAccount->fetchColumn();
...
$title = "General Ledger - " . htmlspecialchars($rentAccountName);
?>
    ...
    <aside class="app-sidebar bg-body-secondary shadow" data-bs-theme="dark">
      ...
      <main class="app-main">
        ...
        <div class="app-content-header">
          ...
          <div class="container-fluid">
            <!--begin::Row-->
            <h2 style="color:#FFC107;">General Ledger - Rent Account</h2>
            
  <!-- Date Filter Form (Only date filters since account is fixed to Rent) -->
        ...
        <table class="table table-bordered table-striped">
            ...
            <tbody>
                ...
                <?php if (empty($ledgerRows)): ?>
                    <tr><td colspan="7" class="text-center text-muted">No rent transactions found</td></tr>
                <?php endif; ?>
            </tbody>
        </table>
    </div>
