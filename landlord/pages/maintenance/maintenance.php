        ...
        <div class="row">
          <div class="col-md-12">
            <div class="card border-0">
              <div class="card-header py-3 d-flex justify-content-between" style="background-color: #00192D; color:#fff;">
                <div>
                  <b>All Requests (<span class="text-warning"> <?= count($currentRequests) ?> </span>)</b>
        ...
        <div class="modal-content">
          <div class="modal-header d-flex align-items-center"
            ...
            <h5 class="modal-title text-white mb-0" id="availabilityModalLabel">
              <i class="fas fa-plus-circle"></i> Submit a Request
            </h5>
